...
/** @type {string} */
const CACHE_VERSION = '1778595829|2771294764';
/** @type {string} */
const CACHE_PREFIX = '3d Pixel Art Out-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '3d Pixel Art Outlines.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["3d Pixel Art Outlines.html","3d Pixel Art Outlines.js","3d Pixel Art Outlines.offline.html","3d Pixel Art Outlines.icon.png","3d Pixel Art Outlines.apple-touch-icon.png","3d Pixel Art Outlines.audio.worklet.js","3d Pixel Art Outlines.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["3d Pixel Art Outlines.wasm","3d Pixel Art Outlines.pck","3d Pixel Art Outlines.side.wasm"];
